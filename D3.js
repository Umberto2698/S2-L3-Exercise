...
console.log("2) ", femaleCharacters);
...
if (crewMass > 1000) {
  console.log("5) DANGER! OVERLOAD ALERT: escape from ship now!");
} else if (crewMass > 900) {
  console.log("5) Critical Load: Over 900");
} else if (crewMass > 700) {
  console.log("5) Warning: Load is over 700");
} else if (crewMass > 500) {
  console.log("5) Ship is half loaded");
} else if (crewMass < 500) {
  console.log("5) Ship is under loaded");
}
...
console.log("6) ", starWarsCharacters);

/* --EXTRA-- ESERCIZIO 9
  Utilizzando gli elementi presenti nell'array "femaleCharacters" rimuovi dall'array "characters" le stringhe corrispondenti a personaggi con lo stesso nome.
  Una volta fatto crea un console.log per controllare la proprietà length di "characters" prima e dopo l'operazione.
*/
console.log("7) prima del ciclo ", characters.length);
...
console.log("7) dopo il ciclo ", characters.length);
/* --EXTRA-- ESERCIZIO 10
